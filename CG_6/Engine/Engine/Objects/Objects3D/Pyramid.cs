...
{
    internal class Pyramid : ObjectsInstance
    {
        public override string Name => "Pyramid";
        public static new string StaticName => "Pyramid";
        ...
        public Pyramid(ObjectManager objectManager) : base(objectManager)
        {
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, CommonData.PyramidVertices.Length * sizeof(float), CommonData.PyramidVertices, BufferUsageHint.DynamicDraw);
        ...
        public override void Draw(BaseCamera camera, Light light, bool isPhysicsWorld = false)
        {
            ...
            GL.DrawArraysInstanced(PrimitiveType.Triangles, 0, 18, Count);
        }
        ...
        public static void Load(List<Object> pyramids, int index, ref string[] settings)
        {
            int start = 2;
            ...
            if (pyramids[index] is Pyramid pyramid)
                pyramid.Create(position, rotate, scale, [color.X, color.Y, color.Z], velocity, mass, [material.X, material.Y, material.Z], physicsEnabled, texturePath);
        }
    }
}
